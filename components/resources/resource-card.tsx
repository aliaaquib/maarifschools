...
export function ResourceCard({
  ...
  return (
    <Card className="group min-w-0 rounded-2xl border border-border p-6 transition-all duration-150 ease-out hover:-translate-y-[2px] hover:shadow-sm">
      ...
      <div className="mt-5 flex flex-col gap-3 border-t border-border pt-4 sm:flex-row sm:items-center sm:justify-between">
        <p className="min-w-0 text-sm font-normal text-muted-foreground">
          {resource.resourceScope === "common" ? "Shared with everyone" : "Shared within one school"}
        </p>
